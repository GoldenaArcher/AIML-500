    ...
    <main className="mx-auto max-w-[1280px] px-8 py-16">
      <article>
        ...
        <Section title="Neural Network Structure">
          <div className="rounded-3xl border border-white/10 bg-[linear-gradient(145deg,rgba(8,12,20,0.94),rgba(18,24,39,0.9))] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.24)]">
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1.2fr)_auto_minmax(0,1fr)] lg:items-stretch">
              <div className="group rounded-2xl border border-sky-300/20 bg-sky-500/10 p-5 transition duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-sky-300/35 hover:shadow-[0_18px_40px_rgba(14,165,233,0.12)]">
                <p className="text-xs uppercase tracking-[0.28em] text-sky-200/80">Input Layer</p>
                <p className="mt-3 text-sm leading-6 text-gray-300">
                  Raw features such as <code>x1</code> and <code>x2</code> enter the network here.
                </p>
              </div>

              <div className="hidden items-center justify-center text-xl text-gray-500 lg:flex">→</div>

              <div className="group rounded-2xl border border-amber-300/20 bg-amber-500/10 p-5 transition duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-amber-300/35 hover:shadow-[0_18px_40px_rgba(245,158,11,0.12)]">
                <p className="text-xs uppercase tracking-[0.28em] text-amber-200/80">Hidden Layers</p>
                <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-amber-100">
                  <span className="rounded-full border border-amber-200/15 bg-black/20 px-3 py-1">Layer 1</span>
                  <span className="text-amber-200/60">→</span>
                  <span className="rounded-full border border-amber-200/15 bg-black/20 px-3 py-1">Layer 2</span>
                  <span className="text-amber-200/60">→</span>
                  <span className="rounded-full border border-amber-200/15 bg-black/20 px-3 py-1">Layer 3</span>
                  <span className="text-amber-200/60">→</span>
                  <span className="rounded-full border border-amber-200/15 bg-black/20 px-3 py-1">Layer n</span>
                </div>
              ...
              <div className="group rounded-2xl border border-emerald-300/20 bg-emerald-500/10 p-5 transition duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-emerald-300/35 hover:shadow-[0_18px_40px_rgba(16,185,129,0.12)]">
                <p className="text-xs uppercase tracking-[0.28em] text-emerald-200/80">Output Layer</p>
                <p className="mt-3 text-sm leading-6 text-gray-300">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {experiments.map((experiment) => (
              <figure
                ...
                className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 transition duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-cyan-300/30 hover:shadow-[0_20px_50px_rgba(0,0,0,0.28)]"
              >
                <div className="border-b border-white/10 px-6 py-4">
                  <h3 className="text-xl font-semibold text-gray-100">{experiment.title}</h3>
                </div>
                <div className="p-4">
                  <Image
                    ...
                    placeholder="blur"
                  />
                  <figcaption className="mt-4 space-y-2 text-sm text-gray-300">
                    <p>{experiment.note}</p>
                    <p className="text-gray-400">{experiment.takeaway}</p>
                  </figcaption>
                </div>
              </figure>
            ))}
        ...
        <Section title="Additional Playground Variations">
          <div className="grid gap-8 lg:grid-cols-2">
            {variations.map((variation) => (
              ...
              >
                <div className="border-b border-white/10 px-6 py-4">
                  <h3 className="text-xl font-semibold text-gray-100">{variation.title}</h3>
                </div>
                <div className="p-4">
                  <Image
                    src={variation.image}
                  ...
                  <figcaption className="mt-4 space-y-2 text-sm text-gray-300">
                    <p>{variation.note}</p>
                    <p className="text-gray-400">{variation.takeaway}</p>
                  </figcaption>
                </div>
              </figure>
            ))}
        ...
        <Section title="Summary and Key Insights">
          <div className="overflow-hidden rounded-3xl border border-cyan-300/15 bg-[linear-gradient(145deg,rgba(8,12,20,0.98),rgba(18,24,39,0.92))] shadow-[0_24px_70px_rgba(0,0,0,0.28)]">
            <div className="border-b border-white/10 px-6 py-5">
              <p className="text-xs uppercase tracking-[0.32em] text-cyan-200/70">Summary Slide</p>
              <h3 className="mt-3 text-2xl font-semibold text-white">Why Visualization Matters</h3>
            ...
            <div className="border-b border-white/10 px-6 py-5">
              <div className="flex flex-col gap-4 text-sm text-gray-300 md:flex-row md:items-center md:justify-between">
                <div className="rounded-full border border-sky-300/20 bg-sky-500/10 px-4 py-2 text-center">Inputs</div>
                <div className="text-gray-500">→</div>
                <div className="rounded-full border border-amber-300/20 bg-amber-500/10 px-4 py-2 text-center">Hidden Layers</div>
                <div className="text-gray-500">→</div>
                <div className="rounded-full border border-fuchsia-300/20 bg-fuchsia-500/10 px-4 py-2 text-center">Decision Boundary</div>
                <div className="text-gray-500">→</div>
                <div className="rounded-full border border-emerald-300/20 bg-emerald-500/10 px-4 py-2 text-center">Prediction</div>
              </div>
            </div>
