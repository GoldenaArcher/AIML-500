...
export default function ComponentCard({ title, text }: ComponentCardProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.16),transparent_45%),radial-gradient(circle_at_bottom_right,rgba(251,191,36,0.10),transparent_35%)] opacity-90 transition duration-300" />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-cyan-300/0 via-cyan-300/80 to-cyan-300/0 opacity-70 transition duration-300" />
